 ...
 blackbeans = Ingredient.create("Black Beans")
 rice = Ingredient.create("Rice")
 onion = Ingredient.create("Onion")
 cheese = Ingredient.create("Cheese")
 butter = Ingredient.create("Butter")
 pasta = Ingredient.create("Pasta")
 carrot = Ingredient.create("Carrot")
 tomatoe = Ingredient.create("Tomatoe")
 habenero = Ingredient.creat("Habenero")
 garlic = Ingredient.create("Garlic")
olive_oil = Ingredient.create("Olive oil")
mayo = Ingredient.create("Mayonase")
tuna = Ingredient.create("Tuna")
pineapple = Ingredient.create("Pineapple")
potatoe = Ingredient.create("Potatoe")
kale = Ingredient.create("Kale")
bay_leaf = Ingredient.create("Bay leaf")
red_pepper = Ingredient.create("Red Peppers")
cumin = Ingredient.create("Cumin")
oregano = Ingredient.create("Oregano")
pepper = Ingredient.create("Pepper")
salt = Ingredient.create("Salt") 
cayenne = Ingredient.create("Cayenne")
blackbeans_and_rice = Recipe.create("Blackbeans and Rice","oak beans overnight to soften and remove any small hard stones. The next day, strain and rinse soaked beans with fresh water.
...
grilledcheese = Recipe.create("Grilled Cheese","take two slices of bread. slather with mayo. add favorite cheese. stick together and cover with butter. cook on low heat for 5 min on each side")
maccheese = Recipe.create("Mac & Cheese","Preheat the oven to 350 degrees F.
...
carrotmash = Recipe.create("Carrot Mash","Preheat oven to 425. Take 3 tomatoes dice into blender Cover with olive oil, blend. Lay carrots habenero peppers and garlic cloves in baking dish and cover with tomatoe oil sauce let bake till vegetables are roasted. take out of oven and mash untill chunky")
tomatoe_sandwhich = Recipe.create("Tomatoe Sandwhich","Take 2 slices of bread. slather with mayo. put slices to over bread salt and pepper put together")
tuna_tacos = Recipe.create("Tuna Tacos w/pineapple","Sear tuna steak on medium heat till golden brown, sear pineapple on medium heat transfer to tortias")
tomato_soup = Recipe.create("Tomatoe Soup","To begin, dice the onion. Melt the butter in a large pot or Dutch oven. Throw in the onion and cook until translucent.
...
Serve the soup warm!")
chilie = Recipe.create("Chilie"," Combine ground beef and 1 1/2 tablespoons chili powder.
...
RecipeIngredient.create(recipe: blackbeans_and_rice, ingredient: redpepper)
...
RecipeIngredient.create(recipe: carrotmash, ingredient: habanero)
