...
blackbeans_and_rice = Recipe.new("Blackbeans and Rice","oak beans overnight to soften and remove any small hard stones. The next day, strain and rinse soaked beans with fresh water.
...
grilledcheese = Recipe.new("Grilled Cheese","take two slices of bread. slather with mayo. add favorite cheese. stick together and cover with butter. cook on low heat for 5 min on each side")
maccheese = Recipe.new("Mac & Cheese","Preheat the oven to 350 degrees F.
